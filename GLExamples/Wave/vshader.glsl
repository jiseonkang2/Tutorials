...
uniform float xs = 5.0, zs = 5.0; // frequencies 
uniform float h = 0.05; // height scale
...
void main()
{
    ...
    //t.y = vPosition.y + h * sin(0.001 * time + xs * vPosition.x) + h * sin(0.001 * time + zs * vPosition.z);
